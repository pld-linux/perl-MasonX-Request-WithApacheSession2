...
MasonX::Request::WithApacheSession. Przy użyciu
HTML::Mason::ApacheHandler2 Mason może działać w środowisku czystego
mod_perl2.

Mason::Request::WithApacheSession2 jest bardzo eksperymentalny (alfa)
i powinien być używany tylko w środowiskach testowych.
